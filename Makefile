...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Apr 24 16:03:08 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) tmp/arenatracker1.0.0/ && $(COPY_FILE) --parents src/local.h src/window_capture.h src/hearthstone.h src/dhasher.h src/scene_manager.h src/tracker.h src/osx_window_capture.h tmp/arenatracker1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/hearthstone.cpp src/dhasher.cpp src/scene_manager.cpp src/tracker.cpp src/osx_window_capture.cpp tmp/arenatracker1.0.0/ && (cd `dirname tmp/arenatracker1.0.0` && $(TAR) arenatracker1.0.0.tar arenatracker1.0.0 && $(COMPRESS) arenatracker1.0.0.tar) && $(MOVE) `dirname tmp/arenatracker1.0.0`/arenatracker1.0.0.tar.gz . && $(DEL_FILE) -r tmp/arenatracker1.0.0
